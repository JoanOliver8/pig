...
comp5_group_count = FOREACH comp5_group GENERATE FILTER Count by comp5.c==1, FILTER Count by comp5.c==0;
STORE comp5_group_count INTO '/user/cloudera/WorkspacePigAnalisisOpinionsExercici/resultat_analisis_opinions_count' USING org.apache.pig.piggybank.storage.CSVExcelStorage(',', 'YES_MULTILINE');
